...
public class BlueScanner extends OpenCvPipeline {
    ...
    Rect leftROI = new Rect(new Point(0, 0), new Point(1280 / 3.0, 360));
    Rect midROI = new Rect(new Point(1280 / 3.0, 0), new Point(2.5 * 1280 / 3.0, 360));
    Rect rightROI = new Rect(new Point(2.5 * 1280 / 3.0, 0), new Point(1280, 360));
